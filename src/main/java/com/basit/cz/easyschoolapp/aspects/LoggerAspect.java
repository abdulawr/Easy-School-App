package com.basit.cz.easyschoolapp.aspects;
...
public class LoggerAspect {
    ...
    @Around("execution(* com.basit.cz.easyschoolapp..*.*(..))")
    ...
    @AfterThrowing(value = "execution(* com.basit.cz.easyschoolapp.*.*(..))",throwing = "ex")
